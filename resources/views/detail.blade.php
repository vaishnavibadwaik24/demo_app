                ...
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            ...
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2">{{ $data->created_at->format('F d, Y') }}</div>
                            <!-- Post categories-->
                            <a class="badge bg-secondary text-decoration-none link-light" href="#!">{{ $data->category->name }}</a>
                        </header>
                        <!-- Preview image figure-->
                        <figure class="mb-4"><img class="img-fluid rounded" src="{{ asset('images/'.$data->photo) }}" alt="Photo" width="400" /></figure>
                        <!-- Post content-->
                        <section class="mb-5">
                    ...
                    <section class="mb-5">
                        <div class="card bg-light">
                            <div class="card-body">
                                <!-- Comment form-->
                                <form class="mb-4" method="POST" action="{{ route('blog.comment',$data->id) }}">
                                    @csrf
