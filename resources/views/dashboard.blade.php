        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 d-flex justify-content-center">
                    <a href="{{ url('category') }}" class="btn btn-warning me-2">View Category</a>
                    <a href="{{ url('blog') }}" class="btn btn-warning">View Blog</a>
                </div>
                {{ __("You're logged in!") }}
            </div>
        </div>
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-2 me-lg-4">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-toggle="dropdown" data-bs-boundary="viewport" aria-expanded="false"><i class="fas fa-user fa-fw"></i></a>
